...
public abstract class HomePage extends BasePage {
	...
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[4]/a/span")
	private WebElement clickEditProfile;
	
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[4]/ul/li[2]/div[3]/a")
	...
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[1]/a/i")
	private WebElement dashboardIcon;
	
	
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[2]/a/i")
	private WebElement POSIcon;
	
	
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[3]/a/i")
	private WebElement SELFIcon;
	
	@FindBy(xpath="html/body/div[1]/header/nav/div/ul/li[4]/ul/li[2]/div[2]/a")
